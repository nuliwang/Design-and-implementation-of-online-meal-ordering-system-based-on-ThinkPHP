<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\PHP\wamp64\www\FooD\public/../application/index\view\person\password.html";i:1620806098;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<form class="am-form am-form-horizontal" action="<?php echo url('index/person/updatePassword'); ?>" method="post">
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="password" name="newpassword" placeholder="由数字、字母、下划线组合">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">确认密码</label>
							<div class="am-form-content">
								<input type="password" name="confirmpassword" placeholder="请再次输入上面的密码">
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="text" style="width: 200px;" name="code" placeholder="验证码"><br>
								<img src="<?php echo captcha_src(); ?>" width="200px" alt="captcha" class="passcode" onclick="this.src=this.src+'?'"/><span style="color: red;padding-left: 30px;">看不清？点我</span>
							</div>
						</div>
						...
						<div class="info-btn">
							...
							<button class="am-btn am-btn-danger">确定修改</button>
						</div>
